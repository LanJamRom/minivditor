...
export abstract class Constants {
  ...
  public static readonly CODE_LANGUAGES: string[] = ["plantuml", "graphviz",, "apache",
    "js", "ts", "html",
    // common
  ...
  public static readonly CDN = `https://d2.smartcost.com.cn/cach/cld/vditor@${VDITOR_VERSION}`;
